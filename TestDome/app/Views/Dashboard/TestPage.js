...
export default class TestPage extends Component {
    constructor(props) {
        ...
        this.state = {
            dataSource:dataSource.cloneWithPages(Bnner_Imgs),
            listData: ds
        };
    }
    ...
    _renderRow(rowData){
        console.log(rowData.right.imageurl);
        return(
                    ...
                    <View style={{flex:1,}}>
                        ...
                        <View>
                            <View  style={styles.menu}>
                                <MenuButton
                                    renderIcon={require('./img/testpage/wdgz.png')}
                                    showText={'我的关注'} tag={'wdgz'}
                                    onClick={this._onMenuClick}
                                />
                                <MenuButton
                                    renderIcon={require('./img/testpage/wlcx.png')}
                                    showText={'物流查询'} tag={'wlcx'}
                                    onClick={this._onMenuClick}
                                />
                                <MenuButton
                                    renderIcon={require('./img/testpage/cz.png')}
                                    showText={'充值'} tag={'cz'}
                                    onClick={this._onMenuClick}
                                />
                                <MenuButton
                                    renderIcon={require('./img/testpage/dyp.png')}
                            ...
                            <View  style={styles.menu}>
                                <MenuButton
                                    renderIcon={require('./img/testpage/yxcz.png')}
                                    showText={'游戏充值'} tag={'yxcz'}
                                    onClick={this._onMenuClick}
                                />
                                <MenuButton
                                    renderIcon={require('./img/testpage/xjk.png')}
                                    showText={'小金库'} tag={'xjk'}
                                    onClick={this._onMenuClick}
                                />
                                <MenuButton
                                    renderIcon={require('./img/testpage/ljd.png')}
                                    showText={'领金豆'} tag={'ljd'}
                                    onClick={this._onMenuClick}
                                />
                                <MenuButton
                                    renderIcon={require('./img/testpage/gd.png')}
                                    showText={'更多'} tag={'gd'}
                                    onClick={this._onMenuClick}
                                />
                            </View>
